...
histograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            inputVariables = cms.vstring("chargedHadronIso"),
        ),
        cms.PSet (
            name = cms.string("photonNeutralHadronIso"),
            title = cms.string("photon NeutralHadronIso; photon nHadIso"),
            binsX = cms.untracked.vdouble(500, -5, 20),
            inputVariables = cms.vstring("neutralHadronIso - rho*Aeff_neutralHadron"),
        ),
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(500, -5, 20),
            inputVariables = cms.vstring("neutralHadronIso"),
        ),
        cms.PSet (
            ...
            inputVariables = cms.vstring("neutralHadronIso - rho*Aeff_neutralHadron", "pt"),
        ),
        cms.PSet (
            name = cms.string("rho"),
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(500, -5, 20),
            inputVariables = cms.vstring("trackIso"),
        ),
        cms.PSet (
